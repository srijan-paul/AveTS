...
import { ErrorType, AveError, ErrorReportFn } from "../error/error";
...
export default class Lexer {
  ...
  constructor(fileName: string, source: string, reporter?: ErrorReportFn) {
  ...
  error(message: string, endPos?: number) {
    ...
    this.reportError(err, this.sourceCode);
    // TODO
  }
